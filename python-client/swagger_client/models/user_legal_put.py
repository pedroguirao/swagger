...
class UserLegalPut(object):
    ...
    def __init__(self, headquarters_address=None, legal_person_type=None, name=None, legal_representative_address=None, legal_representative_birthday=None, legal_representative_country_of_residence=None, legal_representative_nationality=None, legal_representative_email=None, legal_representative_first_name=None, legal_representative_last_name=None, tag=None):  # noqa: E501
        """UserLegalPut - a model defined in Swagger"""  # noqa: E501
    ...
    def headquarters_address(self):
        """Gets the headquarters_address of this UserLegalPut.  # noqa: E501

        he address of the company’s headquarters  # noqa: E501

        :return: The headquarters_address of this UserLegalPut.  # noqa: E501
        :rtype: Address
        """
    ...
    def headquarters_address(self, headquarters_address):
        ...
        :param headquarters_address: The headquarters_address of this UserLegalPut.  # noqa: E501
        :type: Address
        """
    ...
    def legal_person_type(self):
        """Gets the legal_person_type of this UserLegalPut.  # noqa: E501

        The type of legal user  # noqa: E501

        :return: The legal_person_type of this UserLegalPut.  # noqa: E501
        :rtype: str
        """
    ...
    def legal_person_type(self, legal_person_type):
        ...
        :param legal_person_type: The legal_person_type of this UserLegalPut.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this UserLegalPut.  # noqa: E501

        The name of the legal user  # noqa: E501

        :return: The name of this UserLegalPut.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this UserLegalPut.  # noqa: E501
        :type: str
        """
    ...
    def legal_representative_address(self):
        """Gets the legal_representative_address of this UserLegalPut.  # noqa: E501

        The address of the company’s Legal representative person  # noqa: E501

        :return: The legal_representative_address of this UserLegalPut.  # noqa: E501
        :rtype: Address
        """
    ...
    def legal_representative_address(self, legal_representative_address):
        ...
        :param legal_representative_address: The legal_representative_address of this UserLegalPut.  # noqa: E501
        :type: Address
        """
    ...
    def legal_representative_birthday(self):
        """Gets the legal_representative_birthday of this UserLegalPut.  # noqa: E501
        ...
        :return: The legal_representative_birthday of this UserLegalPut.  # noqa: E501
        :rtype: int
        """
    ...
    def legal_representative_birthday(self, legal_representative_birthday):
        ...
        :param legal_representative_birthday: The legal_representative_birthday of this UserLegalPut.  # noqa: E501
        :type: int
        """
    ...
    def legal_representative_country_of_residence(self):
        """Gets the legal_representative_country_of_residence of this UserLegalPut.  # noqa: E501

        The country of residence of the company’s Legal representative person  # noqa: E501

        :return: The legal_representative_country_of_residence of this UserLegalPut.  # noqa: E501
        :rtype: str
        """
    ...
    def legal_representative_country_of_residence(self, legal_representative_country_of_residence):
        ...
        :param legal_representative_country_of_residence: The legal_representative_country_of_residence of this UserLegalPut.  # noqa: E501
        :type: str
        """
    ...
    def legal_representative_nationality(self):
        """Gets the legal_representative_nationality of this UserLegalPut.  # noqa: E501

        The nationality of the company’s Legal representative person  # noqa: E501

        :return: The legal_representative_nationality of this UserLegalPut.  # noqa: E501
        :rtype: str
        """
    ...
    def legal_representative_nationality(self, legal_representative_nationality):
        ...
        :param legal_representative_nationality: The legal_representative_nationality of this UserLegalPut.  # noqa: E501
        :type: str
        """
        allowed_values = ["NotSpecified", "AD", "AE", "AF", "AG", "AI", "AL", "AM", "AO", "AQ", "AR", "AS", "AT", "AU", "AW", "AX", "AZ", "BA", "BB", "BD", "BE", "BF", "BG", "BH", "BI", "BJ", "BL", "BM", "BN", "BO", "BQ", "BR", "BS", "BT", "BV", "BW", "BY", "BZ", "CA", "CC", "CD", "CF", "CG", "CH", "CI", "CK", "CL", "CM", "CN", "CO", "CR", "CU", "CV", "CW", "CX", "CY", "CZ", "DE", "DJ", "DK", "DM", "DO", "DZ", "EC", "EE", "EG", "EH", "ER", "ES", "ET", "FI", "FJ", "FK", "FM", "FO", "FR", "GA", "GB", "GD", "GE", "GF", "GG", "GH", "GI", "GL", "GM", "GN", "GP", "GQ", "GR", "GS", "GT", "GU", "GW", "GY", "HK", "HM", "HN", "HR", "HT", "HU", "ID", "IE", "IL", "IM", "IN", "IO", "IQ", "IR", "IS", "IT", "JE", "JM", "JO", "JP", "KE", "KG", "KH", "KI", "KM", "KN", "KP", "KR", "KW", "KY", "KZ", "LA", "LB", "LC", "LI", "LK", "LR", "LS", "LT", "LU", "LV", "LY", "MA", "MC", "MD", "ME", "MF", "MG", "MH", "MK", "ML", "MM", "MN", "MO", "MP", "MQ", "MR", "MS", "MT", "MU", "MV", "MW", "MX", "MY", "MZ", "NA", "NC", "NE", "NF", "NG", "NI", "NL", "NO", "NP", "NR", "NU", "NZ", "OM", "PA", "PE", "PF", "PG", "PH", "PK", "PL", "PM", "PN", "PR", "PS", "PT", "PW", "PY", "QA", "RE", "RO", "RS", "RU", "RW", "SA", "SB", "SC", "SD", "SE", "SG", "SH", "SI", "SJ", "SK", "SL", "SM", "SN", "SO", "SR", "SS", "ST", "SV", "SX", "SY", "SZ", "TC", "TD", "TF", "TG", "TH", "TJ", "TK", "TL", "TM", "TN", "TO", "TR", "TT", "TV", "TW", "TZ", "UA", "UG", "UM", "US", "UY", "UZ", "VA", "VC", "VE", "VG", "VI", "VN", "VU", "WF", "WS", "YE", "YT", "ZA", "ZM", "ZW"]  # noqa: E501
    ...
    def legal_representative_email(self):
        """Gets the legal_representative_email of this UserLegalPut.  # noqa: E501

        The email of the company’s Legal representative person - must be a valid  # noqa: E501

        :return: The legal_representative_email of this UserLegalPut.  # noqa: E501
        :rtype: str
        """
    ...
    def legal_representative_email(self, legal_representative_email):
        ...
        :param legal_representative_email: The legal_representative_email of this UserLegalPut.  # noqa: E501
        :type: str
        """
    ...
    def legal_representative_first_name(self):
        """Gets the legal_representative_first_name of this UserLegalPut.  # noqa: E501

        The firstname of the company’s Legal representative person  # noqa: E501

        :return: The legal_representative_first_name of this UserLegalPut.  # noqa: E501
        :rtype: str
        """
    ...
    def legal_representative_first_name(self, legal_representative_first_name):
        ...
        :param legal_representative_first_name: The legal_representative_first_name of this UserLegalPut.  # noqa: E501
        :type: str
        """
    ...
    def legal_representative_last_name(self):
        """Gets the legal_representative_last_name of this UserLegalPut.  # noqa: E501

        The lastname of the company’s Legal representative person  # noqa: E501

        :return: The legal_representative_last_name of this UserLegalPut.  # noqa: E501
        :rtype: str
        """
    ...
    def legal_representative_last_name(self, legal_representative_last_name):
        ...
        :param legal_representative_last_name: The legal_representative_last_name of this UserLegalPut.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tag(self):
        """Gets the tag of this UserLegalPut.  # noqa: E501

        Custom data that you can add to this item  # noqa: E501

        :return: The tag of this UserLegalPut.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    def tag(self, tag):
        ...
        :param tag: The tag of this UserLegalPut.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserLegalPut, dict):
